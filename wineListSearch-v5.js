document.addEventListener("DOMContentLoaded", function () {
  ...
  searchInput.addEventListener('input', function () {
    ...
    wineItems.forEach(item => {
      let wineName = item.querySelector('[winelist-data="Name"]');
      let wineProducer = item.querySelector('[winelist-data="Producer"]');
      let wineVintage = item.querySelector('[winelist-data="Vintage"]');
      let wineDistrict = item.querySelector('[winelist-data="District"]');
      let wineSubDistrict = item.querySelector('[winelist-data="Sub district"]');
      let wineCountry = item.querySelector('[winelist-data="Country"]');
